...
def test_no_vote_1():
    ...
    state.players[0].sus = {"1": 0.0, "2": 0.1, "3": 0.2, "4": 0.3}
    state.players[1].sus = {"0": 0.0, "2": 0.1, "3": 0.2, "4": 0.3}
    state.players[2].sus = {"0": 0.5, "1": 0.1, "3": 0.2, "4": 0.3}
    state.players[3].sus = {"0": 0.5, "1": 0.7, "2": 0.2, "4": 0.3}
    state.players[4].sus = {"0": 0.5, "1": 0.1, "2": 0.2, "3": 0.3}
...
def test_no_vote_2():
    ...
    state.players[1].sus = {"0": 0.0, "2": 0.1, "3": 0.2, "4": 0.3}
    state.players[2].sus = {"0": 0.5, "1": 0.1, "3": 0.2, "4": 0.3}
    state.players[3].sus = {"0": 0.5, "1": 1.0, "2": 0.2, "4": 0.3}
    state.players[4].sus = {"0": 0.5, "1": 0.1, "2": 0.2, "3": 0.3}
    tally_the_votes(state=state)
    assert not state.players[0].dead
    assert not state.players[1].dead
...
def test_exile():
    ...
    state.players[1].sus = {"0": 0.0, "2": 0.1, "3": 0.2, "4": 1.0}
    state.players[2].sus = {"0": 0.5, "1": 0.1, "3": 0.2, "4": 1.0}
    state.players[3].sus = {"0": 0.5, "1": 0.1, "2": 0.2, "4": 1.0}
    state.players[4].sus = {"0": 0.8, "1": 0.1, "2": 0.2, "3": 0.3}
    tally_the_votes(state=state)
    assert not state.players[0].dead
    assert not state.players[1].dead
    assert not state.players[2].dead
...
def test_invalid_vote():
    ...
    state.players[0].sus = {"1": 0.0, "2": 0.1, "3": 0.2, "4": 1.0}
    state.players[1].sus = {"0": 0.0, "2": 0.1, "3": 0.2, "4": 1.0}
    state.players[2].sus = {"0": 0.5, "1": 0.1, "3": 0.2, "4": 0.1}
...
def test_vote_to_max_sus():
    ...
    state.players[0].sus = {"1": 0.0, "2": 0.1, "3": 0.2, "4": 1.0}
    state.players[1].sus = {"0": 0.0, "2": 0.1, "3": 0.2, "4": 1.0}
    state.players[2].sus = {"0": 0.9, "1": 0.1, "3": 0.2, "4": 1.0}
    state.players[3].sus = {"0": 1.0, "1": 0.1, "2": 0.2, "4": 0.1}
    state.players[4].sus = {"0": 1.0, "1": 0.1, "2": 0.2, "3": 0.3}
    tally_the_votes(state=state)
    assert not state.players[0].dead
