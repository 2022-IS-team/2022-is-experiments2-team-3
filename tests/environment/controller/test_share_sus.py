...
def test_share_sus():
    ...
    assert state.players[0].others_sus == [[0.0,0.1,0.3,1.0],[0.9,0.1,0.4,1.0],[1.0,0.1,0.2,0.1],[1.0,0.1,0.2,0.3]]
    assert state.players[0].others_sus == [[0.0,0.1,0.2,1.0],[0.9,0.1,0.4,1.0],[1.0,0.1,0.2,0.1],[1.0,0.1,0.2,0.3]]
    assert state.players[0].others_sus == [[0.0,0.1,0.2,1.0],[0.0,0.1,0.3,1.0],[1.0,0.1,0.2,0.1],[1.0,0.1,0.2,0.3]]
    assert state.players[0].others_sus == [[0.0,0.1,0.2,1.0],[0.0,0.1,0.3,1.0],[0.9,0.1,0.4,1.0],[1.0,0.1,0.2,0.3]]
    assert state.players[0].others_sus == [[0.0,0.1,0.2,1.0],[0.0,0.1,0.3,1.0],[0.9,0.1,0.4,1.0],[1.0,0.1,0.2,0.1]]
